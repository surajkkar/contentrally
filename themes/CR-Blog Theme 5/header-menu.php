        ...
        <section class="header-top-container">
            ...
            <div class="left-sec-link"> 
                ...
                <ul class="header-left-links websites-logo">
                	<li class="">
                	   <a href="https://realwealthbusiness.com/" target="_blank" class="header-left-links-a">
                	      <img src="<?php //echo CR_URI.'/img/logos/rwb-logo.png'; ?>" class="referral-site-logo" alt="rwb-logo">
                	   </a>
                	</li>
                	
                	<li class="">
                	   <a href="https://onlinehealthmedia.com/" target="_blank" class="header-left-links-a">
                	      <img src="<?php //echo CR_URI.'/img/logos/ohm-logo.png'; ?>" class="referral-site-logo" alt="ohm-logo">
                	   </a>
                	</li>
                	
                	<li class="">
                	   <a href="https://onlinenewsbuzz.com/" target="_blank" class="header-left-links-a">
                	      <img src="<?php //echo CR_URI.'/img/logos/onb-logo2.png'; ?>" class="referral-site-logo" alt="onb-logo">
                	   </a>
                	</li>                	
		        </ul>
		        -->
