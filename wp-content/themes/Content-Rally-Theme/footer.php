...
<footer class="footer-sec">
    <figure class="absolute bottom-0 object-cover w-full h-fit overflow-hidden mb-0 z-0">
        <img class="w-full h-full object-cover" src="<?php echo get_template_directory_uri(); ?>/images/vector.svg" alt="footer bg" />
    </figure>
    <div class="container mx-auto">
        <div class="footer-main">
            <div class="footer-logo-sec md:w-1/2 lg:w-[35%]">
                <h1 class="footer-c-title">About Us</h1>
                <p class="footer-desc"><?php echo get_option('text'); ?></p>
            </div>
            <div class="footer-detail">
                <div class="md:w-1/3 mb-4 md:mb-0">
                    ...
                    <!-- <ul>
                        ...
                        <li>
                            <a class="footer-link" href="">Advertise</a>
                        </li>
                        <li>
                ...
                <div class="md:w-1/3 mb-4 md:mb-0">
                    <h1 class="footer-c-title">Categories</h1>
                    <?php wp_nav_menu( array(   
                    ...
                    <!-- <ul>
                        ...
                        <li>
                            <a class="footer-link" href="">Entertainment</a>
                        </li>
                        <li>
                            <a class="footer-link" href="">Lifestyle</a>
                        </li>
                        <li>
                            <a class="footer-link" href="">Apps</a>
                        </li>
                        <li>
                            <a class="footer-link" href="">Blogging</a>
                        </li>
                        <li>
                            <a class="footer-link" href="">Dev & Design</a>
                        </li>
                    </ul> -->
                </div>

                <div class="md:w-1/3 mb-4 md:mb-0">
                    <h1 class="footer-c-title">Newsletter</h1>
                    <?php echo do_shortcode("[email-subscribers-form id=1]"); ?>
                    <!-- <div class="input-area mb-12 flex items-center w-full">
                    ...
                    if ($facebook || $twitter || $linkedin) : ?>
                        ...
                        <h1 class="footer-c-title">Follow us</h1>
                        <div class="icons-sec flex gap-4">
                            <?php if ($facebook) : ?>
                                <a class="icon-main" href="<?php echo $facebook; ?>" rel="noopener noreferrer nofollow" target="_blank" aria-label="social_link">
                            ...
                            <?php endif;
                            if ($twitter) : ?>
                                <a class="icon-main" href="<?php echo $twitter; ?>" rel="noopener noreferrer nofollow" target="_blank" aria-label="social_link">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22">
                                        <path fill="none" d="M0 0h24v24H0z" />
        ...
        <div class="copyright">
            ...
            <p class="copyright-desc">
                ...
                <strong class="text-white px-1">
                    <a Class="hover:text-[#EC9A15]" href="http://smartcoders.io/" rel="noopener noreferrer nofollow" target="_blank" aria-label="SmartCoders Website Link">
                        SmartCoders
                    </a>
                </strong>
                .
