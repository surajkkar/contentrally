<?php /* Template Name: category Page Template */ ?>
            ...
            <section class="inner-wrapper lg:w-3/4 border-t-4 border-t-[#EC9A15]">
                <div class="category-wrapper border border-[#E9E9E9] p-4 md:p-8 bg-white mb-8">
                    <h1 class="text-[22px] md:text-[32px] leading-7 md:leading-[44px] text-[#101010] font-bold font-Merriweather pb-4 mb-4 border-b-[1.5px]
                     border-[rgba(0,0,0,0.1)] text-center md:text-start">Category: Business</h1>
                    <p class="text-[#595959] text-base md:text-lg leading-7 md:leading-[34px] font-Ubuntu text-center md:text-start">ContentRally is a leading source of reliable news and trending topics on Business. Get hard-to-find insights and advice on Business from industry-specific leaders.</p>
                </div>
                ...
                <div class="side-bar flex flex-col gap-y-4 md:gap-y-8">
                    ...
                    <div style="margin-top: 0!important;" class="add-post">
                        ...
                        <div class="icons-sec flex gap-4">
                            ...
                            <a class="inner-icon group group" href="">
